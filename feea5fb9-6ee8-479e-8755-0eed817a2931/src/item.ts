...
export default class PlainText implements IScript<Props> {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    switch (props.font) {
      case 'SF':
        text.font = new Font(Fonts.SansSerif)
        break
      case 'SF_Heavy':
    ...
    let wall = new Entity()
    wall.setParent(host)
    wall.addComponentOrReplace(new GLTFShape('feea5fb9-6ee8-479e-8755-0eed817a2931/models/GreenGalleryInfo.glb'))
  }
}
