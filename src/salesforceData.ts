...
export const securitToken: string = ""
...
export const sfOauthUPEndpoint: string = `${sfBaseUrl}/services/oauth2/token?grant_type=password&username=${username}&password=${password}${securitToken}&client_id=${consumerKey}&client_secret=${consumerSecret}`
