import { proxyUrl, sfOauthEndpoint, ContentTypeheaderValueJson, setSfInstanceUrl, setAccessToken } from "./salesforceData"
...
export async function login() {
    ...
    log("=================login called================>")
    let response = await fetch(`${proxyUrl}${sfOauthEndpoint}${jwt}`, {
        headers: { 
